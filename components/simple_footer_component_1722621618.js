            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Monitor new Ethereum transactions as they happen with our powerful on-chain analysis tools. Gain crucial insights into smart contract activity, token transfers, and more.
                    </div>
                </div>
            </div>
        </footer> 
